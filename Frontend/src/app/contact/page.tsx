  ...
  return (
    <MainLayout>
      ...
      <section className="page-shell grid gap-8 py-14 lg:grid-cols-[.72fr_1.28fr] lg:py-20">
        <aside className="rounded-[28px] border border-[#d4e6ed] bg-[linear-gradient(145deg,#edf6ff_0%,#edf6ff_100%)] p-7 text-slate-900 shadow-sm sm:p-9">
          <p className="text-[11px] font-bold uppercase tracking-[0.2em] text-[#78bac5]">Research contact</p>
          ...
          <div className="mt-9 space-y-4">
            {email && <a href={`mailto:${email}`} className="flex items-center gap-3 rounded-2xl border border-[#d8e5ec] bg-[#fffdfb]/72 p-4 text-sm font-semibold"><Mail className="h-4 w-4 text-[#78bac5]" /> {email}</a>}
